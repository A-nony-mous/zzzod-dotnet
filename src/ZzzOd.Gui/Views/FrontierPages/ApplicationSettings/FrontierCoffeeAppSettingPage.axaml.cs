...
internal sealed partial class FrontierCoffeeAppSettingPage : UserControl, IZzzPageLifecycle
{
    ...
    private readonly FASettingsExpander _chooseWayItem;
    private readonly FASettingsExpander _cardNumItem;
    ...
    public FrontierCoffeeAppSettingPage(IZzzAppBackend backend, int instanceIndex, string groupId)
    {
        ...
        _chooseWayItem = Required<FASettingsExpander>("ChooseWayItem");
        _cardNumItem = Required<FASettingsExpander>("CardNumItem");
    ...
    private static void UpdateDescription(FASettingsExpander item, SelectingItemsControl combo)
    {
