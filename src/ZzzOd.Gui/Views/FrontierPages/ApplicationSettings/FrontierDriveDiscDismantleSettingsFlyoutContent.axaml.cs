...
internal sealed partial class FrontierDriveDiscDismantleSettingsFlyoutContent : UserControl, IZzzPageLifecycle
{
    private readonly ZzzDriveDiscDismantleSettingsViewModel _viewModel;
    private readonly FAInfoBar _errorBar;

    public FrontierDriveDiscDismantleSettingsFlyoutContent(
        ...
        string groupId)
    {
        ...
        _viewModel = new ZzzDriveDiscDismantleSettingsViewModel(backend, instanceIndex, groupId, ShowError);
