...
internal sealed partial class FrontierSuibianTempleAppSettingPage : UserControl, IZzzPageLifecycle
{
    ...
    private readonly FASettingsExpander[] _manualItems;
    ...
    public FrontierSuibianTempleAppSettingPage(IZzzAppBackend backend, int instanceIndex, string groupId)
    {
        ...
        _manualItems =
        [
            Required<FASettingsExpander>("YumChaItem"),
            Required<FASettingsExpander>("YumChaRefreshItem"),
            Required<FASettingsExpander>("AdventureDurationItem"),
            Required<FASettingsExpander>("AdventureMissionItem"),
            Required<FASettingsExpander>("CraftDragItem"),
        ];
    ...
    {
        foreach (FASettingsExpander item in _manualItems)
        {
