...
internal sealed partial class FrontierRedemptionCodeAppSettingPage : UserControl, IZzzPageLifecycle
{
    ...
    public FrontierRedemptionCodeAppSettingPage(IZzzRedemptionCodeBackend backend)
    {
        _backend = backend;
