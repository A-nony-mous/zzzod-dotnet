...
internal sealed partial class FrontierWorldPatrolLargeMapIconEditorWindow : Window
{
    ...
    public FrontierWorldPatrolLargeMapIconEditorWindow(IReadOnlyList<ZzzWorldPatrolLargeMapIconDto> icons)
    {
