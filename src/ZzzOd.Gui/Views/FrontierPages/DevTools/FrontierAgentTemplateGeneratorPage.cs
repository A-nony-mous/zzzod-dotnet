...
internal sealed partial class FrontierAgentTemplateGeneratorPage : UserControl, IZzzPageLifecycle
{
    ...
    private readonly FASettingsExpander _templateCards;
    private readonly FAInfoBar _statusBar;
    private readonly List<Bitmap> _previews = [];

    public FrontierAgentTemplateGeneratorPage(IZzzAppBackend backend)
    {
        ...
        _templateCards = Required<FASettingsExpander>("TemplateCards");
