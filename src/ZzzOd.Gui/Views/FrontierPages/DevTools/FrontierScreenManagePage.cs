...
internal sealed partial class FrontierScreenManagePage : UserControl, IZzzPageLifecycle
{
    ...
    private readonly FrontierScreenAreaTable _areaTable;
    ...
    public FrontierScreenManagePage()
    {
        throw new InvalidOperationException("FrontierScreenManagePage 必须通过页面工厂提供真实画面服务。");
    }

    public FrontierScreenManagePage(IZzzScreenManageService service)
    {
        _service = service;
        ...
        _areaTable = Required<FrontierScreenAreaTable>("AreaTable");
    ...
    private void OnPopupTableClicked(object? sender, RoutedEventArgs args)
    {
        ...
        FrontierScreenAreaTable table = new() { DataContext = _areas };
