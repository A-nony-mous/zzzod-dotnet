...
internal sealed partial class FrontierGameAssistantPage : UserControl, IZzzPageLifecycle, IZzzShellBackNavigationHost, IZzzPivotNavigationHost
{
    ...
    public FrontierGameAssistantPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
