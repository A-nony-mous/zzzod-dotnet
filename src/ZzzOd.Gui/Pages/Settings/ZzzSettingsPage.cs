...
internal sealed partial class ZzzSettingsPage : UserControl, IZzzPageLifecycle, IZzzShellBackNavigationHost, IZzzPivotNavigationHost
{
        ...
        ZzzGuiOperationTracker? operations = null)
    {
        ...
        _pages =
        [
            new ZzzGameSettingsAxamlPage(backend, inputMonitor: monitor, operations: _operations),
            new ZzzOverlaySettingsAxamlPage(backend, overlayController, _operations),
            new ZzzResourceDownloadSettingsAxamlPage(backend, resourceDownloadService, _operations),
            new ZzzEnvironmentSettingsAxamlPage(backend, monitor, environmentRuntimeCoordinator, _operations),
            new ZzzPushSettingsAxamlPage(backend, pushNotificationService, _operations),
            new ZzzCustomSettingsAxamlPage(backend, mediaService, _operations),
        ];
