...
internal sealed partial class ZzzPushSettingsAxamlPage : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzPushSettingsAxamlPage(IZzzAppBackend backend, IZzzPushNotificationService pushService, ZzzGuiOperationTracker? operations = null)
    {
        _backend = backend;
