...
internal sealed partial class ZzzBattleAssistantPage : UserControl, IZzzPageLifecycle
{
    private readonly IZzzAppBackend _backend;
    private readonly ZzzBattleAssistantSettings _settings;
    ...
    public ZzzBattleAssistantPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
        : this(new ZzzBattleAssistantSettings(backend), backend, runIntent)
    {
    }

    private ZzzBattleAssistantPage(ZzzBattleAssistantSettings settings, IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
        _backend = backend;
        _settings = settings;
...
internal sealed partial class ZzzCommissionAssistantPage : UserControl, IZzzPageLifecycle
{
    private readonly ZzzCommissionAssistantSettings _settings;

    public ZzzCommissionAssistantPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
        _settings = new ZzzCommissionAssistantSettings(backend);
...
internal sealed partial class ZzzBattleAssistantSettings : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzBattleAssistantSettings(IZzzAppBackend backend)
    {
        _backend = backend;
        AvaloniaXamlLoader.Load(this);
...
internal sealed partial class ZzzCommissionAssistantSettings : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzCommissionAssistantSettings(IZzzAppBackend backend)
    {
        _backend = backend;
        AvaloniaXamlLoader.Load(this);
