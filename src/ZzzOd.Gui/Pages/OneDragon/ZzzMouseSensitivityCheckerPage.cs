...
internal sealed partial class ZzzMouseSensitivityCheckerPage : UserControl, IZzzPageLifecycle
{
    public ZzzMouseSensitivityCheckerPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
