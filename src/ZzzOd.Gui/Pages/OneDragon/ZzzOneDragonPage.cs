...
internal sealed partial class ZzzOneDragonPage : UserControl, IZzzPageLifecycle, IZzzShellBackNavigationHost, IZzzPivotNavigationHost
{
    ...
    public ZzzOneDragonPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent, ZzzGuiOperationTracker? operations = null)
    {
        _operations = operations ?? new ZzzGuiOperationTracker();
        _runPage = new ZzzOneDragonRunPage(backend, runIntent, _operations);
        ...
        [
            _runPageStack,
            new ZzzChargePlanPage(backend),
            new ZzzPredefinedTeamPage(backend, runIntent),
            new ZzzMouseSensitivityCheckerPage(backend, runIntent),
        ];
