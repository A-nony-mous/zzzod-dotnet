...
internal sealed partial class ZzzOneDragonRunPage : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzOneDragonRunPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent, ZzzGuiOperationTracker? operations = null)
    {
        _backend = backend;
    ...
    private void OnGlobalNotifySettingsClicked(object? sender, RoutedEventArgs args)
    {
        ...
        {
            SecondaryPageRequested?.Invoke(this, new ZzzNotifySettingsPage(_backend, instanceIndex));
            return;
        }
