...
internal sealed partial class ZzzWorldPatrolAppSettingPage : UserControl, IZzzPageLifecycle
{
    ...
    private ZzzWorldPatrolLargeMapIconEditorWindow? _largeMapIconEditorWindow;
    ...
    public ZzzWorldPatrolAppSettingPage(
    ...
    private void OnLargeMapViewerPointClicked(object? sender, ZzzWorldPatrolImagePointEventArgs args)
    {
        if (_largeMapState?.HasLargeMap != true)
        {
            return;
    ...
    private void OnRouteMapViewerPointClicked(object? sender, ZzzWorldPatrolImagePointEventArgs args)
    {
        if (_currentRoute is null
            || _routeAreaCombo.SelectedItem is not ZzzWorldPatrolOption area
            || _transportPointCombo.SelectedItem is not ZzzWorldPatrolOption transportPoint)
