...
internal sealed partial class ZzzScreenshotHelperAxamlPage : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzScreenshotHelperAxamlPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
        _backend = backend;
