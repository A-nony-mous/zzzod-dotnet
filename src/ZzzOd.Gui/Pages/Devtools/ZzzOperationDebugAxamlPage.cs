...
internal sealed partial class ZzzOperationDebugAxamlPage : UserControl, IZzzPageLifecycle
{
    ...
    public ZzzOperationDebugAxamlPage(IZzzAppBackend backend, ZzzGuiRunIntentService runIntent)
    {
        _backend = backend;
