...
internal sealed partial class ZzzImageAnalysisPage : UserControl
{
    ...
    public ZzzImageAnalysisPage(IZzzAppBackend backend, IZzzImageAnalysisService service)
    {
        _backend = backend;
        _service = service;
        AvaloniaXamlLoader.Load(this);
