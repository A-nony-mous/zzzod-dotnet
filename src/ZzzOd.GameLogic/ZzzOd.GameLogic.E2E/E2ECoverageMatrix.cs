...
public static class E2ECoverageMatrix
{
	...
	public static IReadOnlyList<E2ECoverageMatrixItem> Items { get; } = new E2ECoverageMatrixItem[58]
	{
		...
		BlockedRuntime("capture.wgc", E2ECoverageArea.Capture, "Windows Graphics Capture", "需要真实游戏窗口句柄、桌面捕获权限和首帧截图。非 E2E 回归 evidence：E2ECaptureReadinessProbeTests 覆盖无窗口失败和首帧摘要记录，7.3 已验证 readiness 支撑测试。", "WindowsGraphicsCaptureScreenCapturer", "WgcCapture"),
